...
def mostrar_competencias():
    ...
    for bloque in info_clase["proficiency_choices"]:
        ...
        for i in range(bloque["choose"]):
            ...
            combo.grid(column=0, row=fila_interna, pady=2, padx=10)
            fila_interna += 1
...
# Centrado del frame principal
frm = ttk.Frame(root, padding=30)
frm.pack(expand=True)
# Configuramos las columnas para que el centro sea real
...
raza_combombox.grid(column=0, row=5, padx=5, sticky="e")
